        ...
        $('[data-countdown]').each(function() {
            ...
            if (!$this.hasClass('countdown-full-format')) {
                $this.countdown(finalDate, function(event) {
                    $this.html(event.strftime('<div class="single"><h1>%D</h1><p>ثانیه</p></div> <div class="single"><h1>%H</h1><p>دقیقه</p></div> <div class="single"><h1>%M</h1><p>ساعت</p></div> <div class="single"><h1>%S</h1><p>روز</p></div>'));
                });
            } else {
                $this.countdown(finalDate, function(event) {
