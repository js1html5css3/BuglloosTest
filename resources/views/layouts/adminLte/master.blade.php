...
@php
    ...
    $cur_user = \App\Models\User::whereId(Auth::id())->first();
@endphp
...
<!-- ./wrapper -->
<div class="loading d-none" id="custom-loader" style="background-color: #3a3a3aa3;z-index:999"><div class="w-100"> <img src="{{asset('images/loader.gif')}}" style="top: 0;bottom: 0;left: 0;right: 0;" width="20%" class="m-auto position-fixed"></div></div>
